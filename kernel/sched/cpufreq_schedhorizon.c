...
static unsigned int default_efficient_freq_pr[] = {CONFIG_SCHEDHORIZON_DEFAULT_EFFICIENT_FREQ_PRIME};
static u64 default_up_delay_pr[] = {CONFIG_SCHEDHORIZON_DEFAULT_UP_DELAY_PRIME * NSEC_PER_MSEC};
