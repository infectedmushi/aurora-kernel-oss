#!/bin/bash
#### UNIFIED BUILDS ####
export KERNEL_DIR="/mnt/Android/aurora_kernel_oneplus_sm8250"
export KBUILD_OUTPUT="/mnt/Android/aurora_kernel_oneplus_sm8250/out"
export ZIP_DIR="/mnt/Android/anykernel3-dawfuk"
export ZIP_OUT_DIR="/mnt/Android/Out_Zips"
rm -rfv /mnt/Android/anykernel3-dawfuk/Image.gz
rm -rfv /mnt/Android/anykernel3-dawfuk/dtbo.img
make O=out clean
make O=out mrproper
rm -rfv out
