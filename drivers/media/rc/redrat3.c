...
static void redrat3_dump_fw_error(struct redrat3_dev *rr3, int code)
{
	...
	case 0x20:
		pr_debug("Initial signal pulse not long enough to measure carrier frequency\n");
		break;
	case 0x21:
		pr_debug("Not enough length values allocated for signal\n");
		break;
	case 0x22:
		pr_debug("Not enough memory allocated for signal data\n");
		break;
	case 0x23:
		pr_debug("Too many signal repeats\n");
		break;
	case 0x28:
		pr_debug("Insufficient memory available for IR signal data memory allocation\n");
		break;
	case 0x29:
		pr_debug("Insufficient memory available for IrDa signal data memory allocation\n");
		break;

	/* Codes 0x30 through 0x3f are USB Firmware Errors */
	case 0x30:
		pr_debug("Insufficient memory available for bulk transfer structure\n");
		break;
	...
	case 0x40:
		if (!rr3->transmitting)
			pr_debug("Signal capture has been terminated\n");
		break;
	case 0x41:
		pr_debug("Attempt to set/get and unknown signal I/O algorithm parameter\n");
		break;
	case 0x42:
		pr_debug("Signal capture already started\n");
		break;
