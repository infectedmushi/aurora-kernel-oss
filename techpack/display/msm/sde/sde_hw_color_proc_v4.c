...
static unsigned short kcal_red = 237;
static unsigned short kcal_green = 238;
static unsigned short kcal_blue = 240;
static unsigned short kcal_hue = 0;
static unsigned short kcal_sat = 275;
static unsigned short kcal_val = 233;
static unsigned short kcal_cont = 258;
